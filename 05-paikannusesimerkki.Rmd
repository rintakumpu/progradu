...
Dynaamista mallia sovellettaessa, voimme myös höydyntää saatavilla olevaa sisätilan karttadataa. Hyödynnetään polygoneja ja raycastingia. Vastaavaa toteutusta ovat hyödyntäneet muun muassa Davidson &al (2010) [@Davidson-2010] sekä Bojja &al (2015) [@Bojja-2015]. Missä edellisessä *** asetetaan rangaistus ja jälkimmäisessä mahdottomaan *** sijaintiin päätyvät hiukkaset poistetaan ja suoritetaan uudelleenotanta. Näitä molempia ajatuksia hyödynnetään paikannusalgoritmissa alla.

Asetetaan esimerkiksi rangaistus 1/1000. Jolloin uskottavuusfunktiot muuttuvat muotoon. Toteutus seuraa Arno Solinin &al artikkelia "Terrain Navigation in the Magnetic Landscape:
Particle Filtering for In door Positioning" [@Solin-2016].
