...
Ohessa esitetyn algoritmin suoritusnopeus on perusmuodossaan luokkaa $\mathcal{O}(N)$. Varianssin estimoinnissa käytetään ALvar-varianssia (kts. yhtälöt (\ref{OD-varianssi}) ja (\ref{ALvar-lambda}). Taulukossa \ref{tab:wb-parametrit} on esitetty algoritmin suunnitteluparametrit, joiden valintaan palataan empiirisessä esimerkissä alla.
