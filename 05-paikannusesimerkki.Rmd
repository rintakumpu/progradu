...
What this does is it finds the first missing data time step and sets the m value correspondingly. If there are consecutive missing data time steps this sets m to correspond to the last of these time steps.  Koska tämä tapahtuu 10 sekunnin kohdalla, valitaan $n=200$. 
...
and m==0 set m=l-t. If m>0 and m+1==l-t set m=l-t if. 
