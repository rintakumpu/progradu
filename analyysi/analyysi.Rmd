...
#write_csv(phase1_summary, "data/tulokset_vaihe1_uusi_varianssi.csv")
#write_rds(phase1_results_list, "data/tulokset_vaihe1_uusi_varianssi.RDS")
...
phase1_summary <- cbind(phase1_values, phase1_results)
phase1_summary$variance[1:3] <- NA
#write_csv(phase1_summary, "data/tulokset_vaihe1_ci_uusi_varianssi.csv")
...
#write_rds(phase1_maps, "data/tulokset_vaihe1_kartat_uusi_varianssi.RDS")
...
#write_csv(phase2_summary, "data/tulokset_vaihe2_uusi_varianssi.csv")
#write_rds(phase2_results_list, "data/tulokset_vaihe2_uusi_varianssi.RDS")
...
phase2_summary <- cbind(phase2_values, phase2_results)
write_csv(phase2_summary, "data/tulokset_vaihe2_ci_uusi_varianssi.csv")

phase2_summary <- read_csv("data/tulokset_vaihe2_ci.csv")
phase2_results_list <- read_rds("data/tulokset_vaihe2.RDS")
phase2_maps <- list()
...
#write_csv(phase3_summary, "data/tulokset_vaihe3_uusi_varianssi.csv")
#write_rds(phase3_results_list, "data/tulokset_vaihe3_uusi_varianssi.RDS")
...
phase3_summary <- cbind(phase3_values, phase3_results)
#write_csv(phase3_summary, "data/tulokset_vaihe3_ci_uusi_varianssi.csv")

#phase3_summary <- read_csv("data/tulokset_vaihe3_ci.csv")
#phase3_results_list <- read_rds("data/tulokset_vaihe3.RDS")
phase3_maps <- list()
...
```{r}
# Plot path plots
#vaihe3 <- read_rds("data/tulokset_vaihe3.RDS")
```
