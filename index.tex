...
Tässä tutkielmassa käytetään seuraavia notaatioita. me vektoria pienella kursiivilla kirjaimella (esim. x) ja matriisia isolla kursiivilla kirjaimella (esim. C). Taulukossa XXX esitetään keskeisimmät lyhenteet ja symbolit.
