...
ja ehtyneet Henok-indeksit määritellään niin, että indeksi on ehtynyt (so. kaikki indeksivektorin indeksit ovat yhtäsuuria) jos jompikumpi ehdoista

\begin{enumerate}
\def\labelenumi{\roman{enumi})}
\tightlist
\item
  Henok-indeksit \(E^i_{m,k-1}\) ovat ehtyneet, \newline
\item
  Henok-indeksit \(E^i_{m-1,k}\) ovat ehtyneet ja on olemassa \(\lambda^\prime \in [0, \lambda-1]\), joka täyttää ehdon \(\hat{\sigma}^2_{k+1,\lambda} (\gamma_{k+1}) < \hat{\sigma}^2_{k+1,\lambda^\prime} (\gamma_{k+1})\), koska myös ehtyneiden indeksien kantaisät ovat ehtyneitä.
\end{enumerate}

\noindent Nyt indeksi \(\lambda_{k+1}\) voidaan valita rekursiivisesti niin, että se tuottaa suurimman varianssiestimaatin, joka on kuitenkin rajoitettu ylhäältä arvoon \(\lambda_k+1\). Tämä indeksi ei ole koskaan ehtynyt, joten se on myös parhaan varianssiestimaatin tuottava valinta.
...
\Begin{
  \For{$t=\{1,2,\ldots,T\}$}{
      ...
      \Begin{Jokaiselle $s$ lasketaan varianssi $\sigma^2_{s|t}$ kuten yhtälössä (\ref{siloitin-varianssi}). Jos $\sigma^2_{s|t} < \epsilon$ poistetaan $s$ joukosta $S$ ja käytetään siloitinjaukauman estimaattia $\sum_i^N w_t^i \tilde{x}_{s|t}^i \Omega_t$ kaikille aika-askeleilla $t^\prime \ge t$.\;}
    }
  }  
...
\midrule
100 & 0.00 & NA & 16.02 & 7.64\\
1000 & 0.00 & NA & 1.41 & 15.35\\
10000 & 0.00 & NA & 0.09 & 85.44\\
100 & 0.10 & 0.07 & 0.10 & 6.97\\
1000 & 0.10 & 0.00 & 0.02 & 14.40\\
\addlinespace
10000 & 0.10 & 0.00 & 0.00 & 82.68\\
100 & 0.67 & 0.06 & 0.06 & 7.16\\
1000 & 0.67 & 0.00 & 0.01 & 14.50\\
10000 & 0.67 & 0.00 & 0.00 & 81.78\\
100 & 1.00 & 0.06 & 0.06 & 7.19\\
\addlinespace
1000 & 1.00 & 0.00 & 0.01 & 14.48\\
...
\midrule
TRUE & 0 & 0.75 & 0 & 0.04 & 43.41\\
TRUE & 100 & 0.75 & 0 & 0.06 & 51.29\\
TRUE & 1000 & 0.75 & 0 & 0.08 & 51.31\\
TRUE & 0 & 1.50 & 0 & 0.02 & 44.12\\
TRUE & 100 & 1.50 & 0 & 0.02 & 51.75\\
\addlinespace
TRUE & 1000 & 1.50 & 0 & 0.03 & 53.26\\
TRUE & 0 & 2.00 & 0 & 0.01 & 45.06\\
TRUE & 100 & 2.00 & 0 & 0.01 & 54.35\\
TRUE & 1000 & 2.00 & 0 & 0.03 & 54.59\\
TRUE & 0 & 2.50 & 0 & 0.01 & 45.97\\
\addlinespace
TRUE & 100 & 2.50 & 0 & 0.01 & 53.70\\
TRUE & 1000 & 2.50 & 0 & 0.02 & 54.39\\
FALSE & 0 & 0.75 & 0 & 0.04 & 16.24\\
FALSE & 0 & 1.50 & 0 & 0.01 & 15.75\\
FALSE & 0 & 2.00 & 0 & 0.01 & 15.02\\
\addlinespace
FALSE & 0 & 2.50 & 0 & 0.01 & 15.28\\
\bottomrule
\end{tabular}
\end{table}
