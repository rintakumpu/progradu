...
jolloin yhden testi. Paikannusvirheeseen palataan luvun tulososassa. Walkbasen laitteistoratkaisu koostuu kolmesta eri komponentista, AT-2-Bluetooth-lähettimistä, jotka kiinnitetään ostoskärryihin. XR-2-Bluetooth-vastaanottimista, jotka kiinnitetään tilan kattoripustuksiin sekä OSCU-laskentayksiköstä, joka luo paikkadataa XR-2-vastaanotinten perusteella ja lähettää paikkadatan edelleen palvelinkeskukseen. Kaavio havainnollistaa \ref{fig:laitteistoarkkitehtuuri} ratkaisun toiminnan.

\begin{figure}[H]
\centering
\includegraphics[width=12cm]{laitteistoarkkitehtuuri}
\caption{Koeasetelman pohjapiirustus}
\label{fig:laitteistoarkkitehtuuri}
\end{figure}

Spesifikaatiot. Ohjelmistoratkai XXX. koska suurin osa prosessoinnista tapahtuu OSCU-laitteella, on tehokkuus.
ja ohjelmistoratkaisu XXX.
