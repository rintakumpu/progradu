...
Yllä esitetyn algoritmin suoritusnopeus on perusmuodossaan luokkaa \(\mathcal{O}(N)\). Varianssin estimoinnissa käytetään ALvar-varianssia (kts. lauseet \ref{OD-varianssi} ja \textbackslash ref\{ALvar-lambda). Taulukossa \ref{tab:wb-parametrit} on esitetty algoritmin suunnitteluparametrit, joiden valintaan palataan empiirisessä esimerkissä alla.
