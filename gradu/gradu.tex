...
Dynaamista mallia sovellettaessa, voimme myös höydyntää saatavilla olevaa sisätilan karttadataa. Hyödynnetään polygoneja ja raycastingia. Vastaavaa toteutusta ovat hyödyntäneet muun muassa Davidson \&al (2010) \citep{Davidson-2010} sekä Bojja \&al (2015) \citep{Bojja-2015}. Missä edellisessä *** asetetaan rangaistus ja jälkimmäisessä mahdottomaan *** sijaintiin päätyvät hiukkaset poistetaan ja suoritetaan uudelleenotanta. Näitä molempia ajatuksia hyödynnetään paikannusalgoritmissa alla.
...
Particle Filtering for In door Positioning'' \citep{Solin-2016}.
